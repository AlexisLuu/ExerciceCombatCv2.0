        ...
        if (pv_monstre <= 0)
            {
                ...
                printf ("Les Heros gagnent 100 points d'expérience ! Ils seront plus puissants envers les monstres ! \n");
                printf ("Un autre monstre apparaît ! \n");
                printf ("Une aura magie entoure les héros, ils gagnent quelques points de vie ! \n");
                pv_monstre = 80;
                pv_heros = pv_heros + 60;
            }
            
            if (pv_heros <= 0)
            {
                printf ("Heros n'a plus de PV, Monstre gagne...\n");
                printf ("Le monstre devient de plus en plus fort...");
            }
        }
    return 0;
}